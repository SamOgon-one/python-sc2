...
class BotAIInternal(ABC):
    ...
    def _initialize_variables(self):
        ...
        self.units_of_type: Dict[UnitTypeId, Units([], self)] = defaultdict(lambda: Units([], self)) # (?) name all_units_of_type or units_of_type_id or split into units_of_type and structures_of_type
        ...
        self._structures_previous_map: Dict[int, Unit] = {} # carefull for iteration 0 
    ...
    def _prepare_step(self, state, proto_game_info):
        ...
        if self.enemy_race == Race.Random and self.all_enemy_units:
            ...
            self.chat_send(str(self.enemy_race), True)
        ...
        for unit in self.state.observation_raw.units:
            if unit.is_blip:
                ...
                # Alliance.Self.value = 1
                    ...
                    self.units_of_type[unit_id].append(unit_obj)
